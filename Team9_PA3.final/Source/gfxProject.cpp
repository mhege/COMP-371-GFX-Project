...
int main(int argc, char* argv[])
{
	...
	GLuint rubber = generate.loadTexture("../Assets/Textures/black.jpg");
	GLuint carTextures1 = generate.loadTexture("../Assets/Textures/red_car.jpg");
	...
	*/
	...
	//create car
	Car car0;
	car0.Textures[0] = carTextures1;//TODO: FIx this, seems off
	car0.Textures[2] = rubber;//
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		car0.vaoCube = vaoCubeShadow;
		car0.draw(worldMatrixLocation, groupMatrixW);
		for (int i = 0; i < 9; i++) {
